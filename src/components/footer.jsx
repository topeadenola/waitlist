...
const Footer = () => {
  ...
  return (
    <div className="bg-white w-full text-white custom-font font-light py-10 pb-8 text-sm">
      <div className="max-w-6xl mx-auto ">
        <div className=" flex flex-col justify-around gap-6 md:gap-0 md:flex-row md:justify-center md:items-end border-b-2 pb-4 mb-4 md:pb-2 border-[#4747471A]">
